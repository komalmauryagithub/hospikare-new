...
async function loadPayments(){
    ...
    try{
        ...
        <div id="paymentsSection">
            <div style="margin-bottom: 16px;">
                <h2 style="font-family: var(--font-heading);">Payment History</h2>
            </div>
        ...
        if(result.success){
            ...
            result.payments.forEach(payment => {
                ...
                <tr>
                    ...
                    <td><span style="padding: 4px 8px; border-radius: 4px; font-size: 12px; background: ${payment.payout_status.toLowerCase() === 'completed' || payment.payout_status.toLowerCase() === 'paid' ? 'var(--trend-up-bg)' : 'var(--trend-down-bg)'}; color: ${payment.payout_status.toLowerCase() === 'completed' || payment.payout_status.toLowerCase() === 'paid' ? 'var(--trend-up)' : 'var(--trend-down)'};">${payment.payout_status}</span></td>
