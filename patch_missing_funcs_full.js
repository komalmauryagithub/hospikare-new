...
const oldCode = fs.readFileSync('scratch/users_full_old.js', 'utf8');
...
if (startIndex !== -1 && endIndex !== -1) {
    ...
    // Insert it into currentCode right before loadMedicines()
    ...
    console.log('Could not find markers in old code. ' + startIndex + ' ' + endIndex);
}
